odoo.define('odoo_board.whiteboard_component', function (require) {
    'use strict';

    var { Component, useState, useRef, onMounted } = require("@odoo/owl");
    var { registry } = require("@web/core/registry");
    var WhiteboardElement = require('odoo_board.whiteboard_element');
